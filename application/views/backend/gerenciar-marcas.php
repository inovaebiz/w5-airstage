...
<nav aria-label="breadcrumb">
	<ol class="breadcrumb">
		...
		<li class="breadcrumb-item active" aria-current="page">Cadastro de Marcas</li>
	</ol>
</nav>
<!-- CONTAINER -->
...
<form method="POST" action="" class="form-cadastro">
	...
	<div class="row">
	  <div class="input-group col-md-6">
	    <input type="text" class="form-control" name="marca_nome" id="marca_pontos" placeholder="Nome da Marca"> 
	  </div>
		<div class="f1-buttons col-md-3">
			<div class="onoffswitch3">
			    <input type="checkbox" name="marca_status" class="onoffswitch3-checkbox" id="ativar" checked>
	  ...
	  <div class="f1-buttons col-md-3">
		  ...
		  <span class="btn-label"><i class="fa fa-plus" aria-hidden="true"></i>Nova Marca</span></button>
	  </div>
  ...
  <tbody class="forms">
    	...
    	<tr>
			...
			<td class="text-center">
				...
				<span class="<?= $item->marca_status == 1 ? 'ativo' : 'status'?>"><?= $item->marca_status == 1 ? 'Ativo' : 'Inativo'?></span>
			</td>
			<td>
				<a href="<?= base_url() ?>control/marcas/editar/<?=$item->marca_id?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				<a href="<?= base_url() ?>control/marcas/excluir/<?=$item->marca_id?>"><i class="fa fa-times-circle" aria-hidden="true"></i></a>
			</td>
