          ...
          <form class="form-inline" method="get">
            ...
            <?php if ((isset($_GET['e']) || isset($_GET['s']))) { ?>
              <div class="f1-buttons col-6 col-sm-6 col-md-3 col-lg-3">
                <a type="href" href="/control/pag/dashboardXLS?<?= http_build_query($_GET, '&') ?>" class="btn btn-primary btn-black "> <i class="fa fa-bar-chart" aria-hidden="true"></i> Gerar Relatório</a>
              </div>
            <?php } ?>
          </form>
        </div>
          ...
          <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon01.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon02.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $obras ?></span>
                ...
                <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon03.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $pontos_a ?></span>
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon04.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $highWallF ?></span>
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon05.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon06.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $teto ?></span>
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon07.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $cassete ?></span>
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon08.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $multi ?></span>
                ...
                <!-- <div class="col-12 col-sm-6 col-md-6 col-lg-6 col-xl-4">
                  <div class="box-descricao">
                    <img class="img-fluid icon-dash" src="/assets-control/img/icon/icon09.png" alt="Projeto Família Airstage" title="Projeto Família Airstage">
                    <span><?= $equip_ex ?></span>
