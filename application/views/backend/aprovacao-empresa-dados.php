...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-12 col-lg-9 col-xl-8 offset-xl-1">
      ...
      <h1>Aprovação de Credenciado</h1>
            ...
            <table id="dados-empresa" class="table table-striped table-bordered dt-responsive nowrap">
              ...
              <tbody>
                ...
                <tr>
                  <td>CREDENCIADO</td>
                  <td>
                    <select class="form-control form-control-interno" onchange="setCredenciado(this)" required>
              ...
              <div class="form-row">
                ...
                <div class="form-group col-12 col-sm-12 col-md-2 col-lg-3 col-xl-3">
                  <form action="" method="post">
                    ...
                    <input type="hidden" name="cliente_credenciado" id="is_cliente_credenciado" value="1">
...
<script>
  function setCredenciado(e) {
    $("#is_cliente_credenciado").val(e.value);
  }
</script>