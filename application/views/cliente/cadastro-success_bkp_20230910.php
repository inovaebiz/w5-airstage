<div class="loader">
    <div class="col-lg-8 text-center mx-auto">
        <img class="animated infinite" src="https://familiaairstage.com.br/assets-cliente/img/logo-familia-fujitsu.svg" width="150" height="auto" title="Familia Airstage" alt="Familia Airstage"><br />
...
<body>
    ...
    <header>
        <div class="container-fluid ">
            <div class="row">
                <div class="col-lg-4 logo-cadastro"><img class="logo-fujitsu" src="/assets-cliente/img/logo-fujitsu-fujitsu-general-brazil.svg" alt="Família Airstage" title="Família Airstage"></div>

                <div class="col-sm-12 col-md-6 col-lg-4 text-center"><img class="logo-projeto w-25" src="/assets-cliente/img/logo-familia-fujitsu.svg" alt="Projeto Família Airstage" title="Projeto Família Airstage"></div>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4 link-login">
                    ...
                    <a href="home-login-cadastro.php" class="btn btn-lg btn-primary" alt="Faça seu login" title="Faça seu login"> <img class="img-fluid" src="/assets-cliente/img/arrow.png" alt="Família Airstage" title="Família Airstage"> Faça seu Login </a>
                </div>
            </div>
        </div>
    </header>
    ...
    <div style='display:none' id="div-success">
        ...
        <div id="inline_content" class="text-center">
            <div class="col-md-12">
                <img class="img-fluid" src="/assets-login/img/icone-final.png" alt="Família Airstage" title="Família Airstage">
