							...
							<div class="form-cadastro mb-3">
										...
										<div class="col-md-12 row-categoria" id="equip-<?= $dataEquip->ok_id ?>">
											<div class="row">
												<div class="input-group col-md-6">
													<select name="" id="selCat-<?= $dataEquip->ok_id ?>" class="form-control row-cat" onchange="cat(this)" disabled>
								...
								<?php else : ?>
									...
									<div class="col-md-12 row-categoria">
										<div class="row">
											<div class="input-group col-md-6">
												<select name="" id="selCat" class="form-control row-cat" onchange="cat(this)">
													<option value="">Selecione a categoria</option>
													<?php foreach ($cats->result() as $c) : ?>
										...
										<div class="row">
											<div class="input-group col-md-6">
												<select name="categ[]" id="selTipo" class="form-control row-tipo item-tipo modelo" onchange="tipo(this)">
													<option value="">Condensador</option>
												</select>
											</div>
											<div class="input-group col-md-6">
												<input type="tel" id="validaSerieCondensadora" name="eSerie[]" maxlength="10" minlength="6" placeholder="Número de série" class="form-control row-tipo item-tipo" onkeyup="validarCondensadora(this)">
											</div>
										</div>
										<div class="row">
											<div class="input-group col-md-6">
