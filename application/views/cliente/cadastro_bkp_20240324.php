                ...
                <form role="form" action="" method="post" class="f1">
                    ...
                    <fieldset>
                        <div class="form-wrapper">
                            ...
                            <div class="form-group">
                                <select name="distribuidoresparceiros[]" title="Distribuidores Parceiros*" id="distribuidoresparceiros" class="form-control selectpicker" multiple data-live-search="true" required onchange="validForm()">
                                </select>
                            </div>
...
<script>
    ...
    function validForm() {
        let parceiros = document.querySelector("#distribuidoresparceiros");
        if (parceiros.value !== "") {
...
<script>
    ...
    for (distribuidor of distribuidores) {
        ...
        document.getElementById('distribuidoresparceiros').innerHTML += html;
    }
