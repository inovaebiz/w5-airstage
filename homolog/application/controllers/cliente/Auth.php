...
class auth extends CI_Controller
{
  ...
  public function cadastrar()
  {
    ...
    if ($this->form_validation->run()) {
      ...
      $dados['distribuidores_parceiros'] = join(", ", $dados['distribuidores_parceiros']);
      unset($dados['resenha']);
      ...
      // Dados do e-mail cliente
      
      // Variaveis para do configurações de e-mail
      $from_name = $dados['cliente_razao_social'];
      $from_email = $dados['cliente_email'];
      $subject_prefix = $this->config->item('subject_prefix');
  ...
  public function meus_dados()
  {
    ...
    //var_dump($cliente);
    $distribuidores = $cliente->distribuidores_parceiros;
  ...
  function envia_recuperacao($usuario = NULL)
  {
    ...
    // Variaveis para do configurações de e-mail
    $from_name = $this->config->item('from_name');
    $from_email = $usuario->cliente_email;
    $subject_prefix = $this->config->item('subject_prefix');
