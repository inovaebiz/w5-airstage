	...
	<tbody>
		...
		?>
			<tr>
				...
				<td colspan="11">Data Final: <?= str_replace('-', '/', $datefim) ?></td>
			</tr>
			<tr>
				<td>
					<b>ID OBRA</b>
						...
						<tr>
							...
							<td>
								<?php if ($existe != $item->obra_id) { ?>
									...
									if (!empty($item->obra_nota_fiscal_data_distribuidor && $item->obra_nota_fiscal_data_distribuidor != '0000-00-00 00:00:00')) {
										
										$obra_nota_fiscal_data_distribuidor = date('d/m/Y', strtotime($item->obra_nota_fiscal_data_distribuidor));
									
									} else {
									
										$obra_nota_fiscal_data_distribuidor = '';
									
									}
									
									echo $obra_nota_fiscal_data_distribuidor;
