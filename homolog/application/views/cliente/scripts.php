<script src="<?php echo base_url(); ?>assets-login/js/jquery/2.1.1/jquery.min.js"></script>
<script src="<?php echo base_url(); ?>assets-login/js/bootstrap/4.1.1/bootstrap.bundle.min.js"></script>
<script src="<?php echo base_url(); ?>assets-login/js/bootstrap-select/1.13.1/bootstrap-select.min.js"></script>
