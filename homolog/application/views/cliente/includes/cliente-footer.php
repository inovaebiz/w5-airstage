                        ...
                        <div class="col-12 col-sm-12  col-md-4 col-lg-4 col-xl-4 no-padding ">
                            ...
                            <div class="base-banner">
                                ...
                                <?php 
                                        ...
                                        if(strtotime($camp->campanha_data_final) <= strtotime($data)) {
                                
                                ?>
                                            <h2 style="padding-top: 30px; color: #fff">Campanha Encerrada</h2>
                                            <span>Em breve, teremos novidades sobre a próxima campanha.</span>
                                <?php
                                ...
                                <?php
                                            if(strtotime($camp->campanha_data_final_resgate) <= strtotime($data)) {
                                ?>                                
...
<script src="<?php echo base_url(); ?>assets-cliente/js/bootstrap-select/1.13.1/bootstrap-select.min.js"></script>
...
<script>
    ...
    */
    ...
    $('#filter-date, #search-from-date, #search-to-date').on('scroll', function() {
        return false;
    });
</script>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        if (typeof getDistribuidores === 'function') {
            getDistribuidores();
        }
    });
</script>
