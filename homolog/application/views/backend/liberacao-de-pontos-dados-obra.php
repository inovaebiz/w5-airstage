...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><a href="<?= base_url('control/pontos/') ?>">Liberação de pontos</a></li>
...
<div class="container-fluid">
  <div class="row">
    ...
    <main role="main" class="col-md-12 col-lg-9 col-xl-8 offset-xl-1">
      ...
      <!-- link-voltar -->
      <a href="<?= base_url('control/pontos/') ?>" class="link-voltar"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Voltar</a>
            ...
            <div class="botoes-aprovacao">
              ...
              <div class="row">
                ...
                <div class="col-12 col-sm-9 col-md-8 col-lg-8 col-xl-8 offset-xl-2">
                  ...
                  <button type="submit" class="btn btn-primary btn-red">Recusar</button>
                </div>
