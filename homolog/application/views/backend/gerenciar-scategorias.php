	...
	<div class="row">
	  <div class="input-group col-md-12">
		...
		<div class="input-group col-md-6">
			<input type="hidden" class="form-control" name="sc_pontos" id="sc_pontos" placeholder="pontos" value="0"> 
		</div>
...
<!-- Tabela -->
  ...
  <tbody class="forms">
    	...
    	<tr>
			...
			<td>
				<a href="<?= base_url() ?>control/equipamentos/editar-categoria/<?=$item->sc_id?>"><i class="fa fa-pencil" aria-hidden="true"></i></a>
				<!-- <a href="<?= base_url() ?>control/equipamentos/excluir-categoria/<?=$item->sc_id?>"><i class="fa fa-times-circle" aria-hidden="true"></i></a> -->
				<a href="<?= base_url() ?>control/equipamentos/gerenciar-tipos/<?=$item->sc_id?>"><i class="fa fa-bookmark" aria-hidden="true"></i></a>
			</td>
