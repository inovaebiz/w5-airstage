...
<h1>Editar equipamento Airstage</h1>
...
<form method="POST" class="form-cadastro" onsubmit="cadastrar()">
	<input type="hidden" name="equipamento_id" value="<?=$t->equipamento_id?>">

	<div class="row">
	  <div class="input-group col-md-12">
	    <input type="text" class="form-control" name="equipamento_nome" id="equipamento_nome" placeholder="Nome" value="<?=$t->equipamento_nome?>"> 
	  </div>
		...
		<div class="f1-buttons col-md-3">
			<div class="onoffswitch3">
			    <input type="checkbox" name="equipamento_status" class="onoffswitch3-checkbox" id="ativar" <?=$t->equipamento_status == 1 ? "checked" : ""?>>
...
<!-- link-voltar -->
<a href="<?= base_url('control/equipamentos/gerenciar-equipamentos/'.$t->equipamento_tipo)?>" class="link-voltar"><i class="fa fa-angle-double-left" aria-hidden="true"></i> Voltar</a>
